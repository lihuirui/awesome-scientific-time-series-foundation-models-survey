...
\thanks{Manuscript version 1.9 (P8/P9 Continuous Research Iteration), September 27, 2026.}
}
...
\input{sections/03_taxonomy.tex}
\input{sections/04_core_methods.tex}
\input{sections/05_domain_applications.tex}
\input{sections/06_reasoning_llms.tex}
\input{sections/07_benchmarks.tex}
\input{sections/08_future_directions.tex}
